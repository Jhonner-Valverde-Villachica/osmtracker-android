...
public class TracklistAdapter extends CursorAdapter {
    ...
    private View bind(Cursor cursor, View v, Context context) {
        ...
        TextView vStats = (TextView) v.findViewById(R.id.trackmgr_item_stats);
        ...
        int wpCount = t.getWpCount();
        int tpCount = t.getTpCount();

        if (vStats != null) {
            String combinedInfo = context.getString(R.string.trackmgr_stats_combined, wpCount, tpCount);
            vStats.setText(combinedInfo);
        }
